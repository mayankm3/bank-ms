package com.dev.gatewayserver.filters;
...
public class RequestTraceFilter implements GlobalFilter{
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        if (isCorrelationIdPresent(requestHeaders)) {   // to prevent generating a new ID if request somehow again reaches gateway server
